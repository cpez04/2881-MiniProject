#!/bin/bash
# Run firewall evaluation on open models only (no HuggingFace auth required)
...
echo "========================================"
echo "Open Models Firewall Evaluation"
echo "========================================"
echo "Min Overlap: $MIN_OVERLAP"
echo "Bootstrap Samples: $N_BOOTSTRAP"
echo "(No HuggingFace authentication required)"
echo "========================================"
echo ""
...
# Open model configurations (no auth required)
declare -a MODELS=(
